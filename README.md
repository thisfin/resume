...
- 兴趣较为广泛, 对于一些新的技术比较关注, 有大型系统开发及其架构方面的经验. 对于 java 技术体系和移动端应用有丰富开发设计经验.

- 有 macOS 下 app 的开发技能, 有前端开发技能

---

### 工作经历

* **2017年11月至今 杭州洋驼网络科技有限公司**

    - 客户端负责人, 负责公司客户端团队(规模20+人)的管理工作, 公司内多个客户端的技术选型及过程优化.

    - 主要内容: 版本迭代优化, 一月一版至每周一版; 路由组件设计实施; hybrid 优化(缓存, 预请求, 通用接口), 新技术推动, Swift, Kotlin, Rx; 持续集成, 工程模块化拆分, 多 app 模块复用, Jenkins, 混编方案, 静态化优化, gitlab CI, git-flow; 新技术及跨平台技术调研, ReactNative, flutter, dsl 规则渲染, 无痕埋点;
...
* **2016年08月2017年10月 阿里体育(上海)有限公司**

    - 以商家和会员为两个重点, 与集团内现有体系做对接. 商家端以多样化的流量引导为卖点, 对不同的后台功能做整合打通, 为商家提供从入驻到营销管理以及支付的整一套流程解决方案; 会员端以增加用户粘性和 dau 为目标, 丰富玩法和提供多端的支持. 技术方面做了架构设计, 产出方案. 整个过程涉及多 bu 的多条业务线, 很多功能都是并行开发, 积累了很多协作开发的经验.
...
* **2012年03月至2016年08月 浙江天猫技术有限公司**
    ...
    - 客户端项目的主要目标在 dau, 引导成交, 稳定性, 流畅度以及业务多样性快速响应等方面. 带领团队做了整个工程的梳理. 核心功能组件做封装, 业务逻辑部分大量使用动态化模块, 通过配置的方式来支持功能快速迭代
    - 服务端项目主要目标在大数据量的处理以及稳定性建设. 核心代码和逻辑代码做解耦拆分, 业务逻辑处理引入动态脚本语言执行. 应用服务按照业务做拆分; 服务接口做细粒度监控及报表化产出

    - 项目: 天猫客户端iOS开发

        - 项目描述:
        涉及搜索/类目/收藏夹/优惠券等模块. 做组件模块化拆分, 数据与渲染分离, 以及高并发时服务端的负载处理

        - 责任描述:
        带领团队, 做技术方案设计, 技术升级, 参与日常开发, 服务端通信接口指定, 项目优化以及和android端的架构统一, 以及埋点配置平台的建设
        同时负责收藏夹服务端的开发工作, 做增量需求的开发以及稳定性建设.
